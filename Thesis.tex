...
\makeatletter
\newcases{casesLR}{\quad}{%
  $\m@th\displaystyle{##}$\hfil}{\hfil$\m@th\displaystyle{##}$}{\lbrace}{.}
\makeatother
...
%---Notes---
%OK - A conscientiously written scientific report in Swedish or English where the problem is introduced, different methods for the solution are discussed, the method chosen is presented, the solution and the results are described and the results are analyzed
...
%I would like to thank my supervisor Roberto Guanciale, for his feedback and guiding throughout the research and writing of this thesis. 
%Also, I would like to thank my family for supporting me throughout my studies and the research conducted in this thesis.
%\\ \\
%Thank you! 
%\\ \\ \\ \\
...
\textbf{Word:} 2 bytes.\\
%Generalized CFA, Fuzzing, static analysis, dynamic analysis, soundness, accuracy, precision?
...
%\subsection{Challenges of Control Flow Reconstruction in Static Analysis}
%\subsection{Static Control Flow Reconstruction Challenges}
...
%See summary of https://www.youtube.com/watch?v=EF_6QaQ_M-s&t=20
...
%Note that there is nothing such as a top node in the ideal graph since a top node, by definition, is a node whose successors are unknown and the ideal graph does not contain any nodes with unknown successors.
...
%In abstract interpretation, it is also common to use a transfer function. A transfer function + widening function
%See Jakstab 3.4
...
\textbf{Binary} & \textbf{Mode} & \textbf{Instructions} & \textbf{$\mathcal{A}_{E_I,E_G}$} & \textbf{$\mathcal{P}_{E_I,E_G}$} & \textbf{$\mathcal{S}_{E_I,E_G}$} & \textbf{uTops} & \textbf{Tops} & \textbf{$\mathcal{A}_{E_I,E_{TEF}}$} & \textbf{$\mathcal{P}_{E_I,E_{TEF}}$} & \textbf{$\mathcal{S}_{E_I,E_{TEF}}$} \\ \Xhline{2\arrayrulewidth} 
badCall & c & 4 & 14.81 & 40.74 & 66.67 & 1 & 1 & 100.0 & 75.00 & 50.00 \\ \hline
badCall & cD & 7 & 20.00 & 60.00 & 100.0 & 0 & 1 & 83.33 & 83.33 & 83.33\% \\ \hline
badCall & i & 7 & 85.71 & 92.86 & 100.0 & 0 & 0 & 85.71 & 92.86 & 100.0 \\ \hline
badCall & iD & 7 & 85.71 & 92.86 & 100.0 & 0 & 0 & 85.71 & 92.86 & 100.0 \\ \Xhline{2\arrayrulewidth} 
badIndMemJmp & c & 1 & 22.22 & 44.44 & 66.67 & 1 & 1 & - & - & 0.00 \\ \hline
badIndMemJmp & cD & 1 & 22.22 & 44.44 & 66.67 & 0 & 1 & - & - & 0.00 \\ \hline
badIndMemJmp & i & 1 & 0.00 & 0.00 & 0.00 & 0 & 0 & 0.00 & 0.00 & 0.00 \\ \hline
badIndMemJmp & iD & 1 & 0.00 & 0.00 & 0.00 & 0 & 0 & 0.00 & 0.00 & 0.00 \\ \Xhline{2\arrayrulewidth} 
branch & c & 17 & 20.45 & 60.23 & 100.0 & 1 & 1 & 94.12 & 91.50 & 88.89\% \\ \hline
branch & cD & 17 & 20.45 & 60.23 & 100.0 & 0 & 1 & 94.12 & 91.50 & 88.89\% \\ \hline
branch & i & 17 & 94.74 & 97.37 & 100.0 & 0 & 0 & 94.74 & 97.37 & 100.0 \\ \hline
branch & iD & 17 & 94.74 & 97.37 & 100.0 & 0 & 0 & 94.74 & 97.37 & 100.0 \\ \Xhline{2\arrayrulewidth} 
callRet & c & 2 & 8.33 & 24.17 & 40.00 & 1 & 1 & 100.0 & 60.00 & 20.00 \\ \hline
callRet & cD & 6 & 17.86 & 58.93 & 100.0 & 0 & 1 & 80.00 & 80.00 & 80.00 \\ \hline
callRet & i & 6 & 83.33 & 91.67 & 100.0 & 0 & 0 & 83.33 & 91.67 & 100.0 \\ \hline
...
\Xhline{2\arrayrulewidth}
\textbf{Binary} & \textbf{Mode} & \textbf{Instructions} & \textbf{$\mathcal{A}_{E_I,E_G}$} & \textbf{$\mathcal{P}_{E_I,E_G}$} & \textbf{$\mathcal{S}_{E_I,E_G}$} & \textbf{uTops} & \textbf{Tops} & \textbf{$\mathcal{A}_{E_I,E_{TEF}}$} & \textbf{$\mathcal{P}_{E_I,E_{TEF}}$} & \textbf{$\mathcal{S}_{E_I,E_{TEF}}$} \\ \Xhline{2\arrayrulewidth} 
longRegisterEquals & c & 14 & 15.38 & 57.69 & 100.0 & 1 & 1 & 66.67 & 83.33 & 100.0 \\ \hline
longRegisterEquals & cD & 14 & 15.38 & 57.69 & 100.0 & 1 & 1 & 66.67 & 83.33 & 100.0 \\ \hline
longRegisterEquals & i & 14 & 15.38 & 57.69 & 100.0 & 1 & 1 & 66.67 & 83.33 & 100.0 \\ \hline
longRegisterEquals & iD & 14 & 15.38 & 57.69 & 100.0 & 1 & 1 & 66.67 & 83.33 & 100.0 \\ \Xhline{2\arrayrulewidth} 
memCallRet & c & 4 & 10.53 & 33.83 & 57.14 & 1 & 1 & 100.0 & 71.43 & 42.86\% \\ \hline
memCallRet & cD & 8 & 16.67 & 58.33 & 100.0 & 0 & 1 & 85.71 & 85.71 & 85.71\% \\ \hline
memCallRet & i & 8 & 87.50 & 93.75 & 100.0 & 0 & 0 & 87.50 & 93.75 & 100.0 \\ \hline
memCallRet & iD & 8 & 87.50 & 93.75 & 100.0 & 0 & 0 & 87.50 & 93.75 & 100.0 \\ \Xhline{2\arrayrulewidth} 
minimalistic & c & 5 & 10.71 & 20.36 & 30.00 & 1 & 1 & 100.0 & 60.00 & 20.00 \\ \hline
minimalistic & cD & 11 & 19.35 & 39.68 & 60.00 & 0 & 1 & 100.0 & 75.00 & 50.00 \\ \hline
minimalistic & i & 11 & 19.35 & 39.68 & 60.00 & 1 & 1 & 100.0 & 75.00 & 50.00 \\ \hline
minimalistic $\triangle_{T}$ & iD & 15 & 13.68 & 46.84 & 80.00 & 1 & 2 & 100.0 & 82.50 & 65.00 \\ \Xhline{2\arrayrulewidth} 
...
\textbf{Binary} & \textbf{Mode} & \textbf{Instructions} & \textbf{$\mathcal{A}_{E_I,E_G}$} & \textbf{$\mathcal{P}_{E_I,E_G}$} & \textbf{$\mathcal{S}_{E_I,E_G}$} & \textbf{uTops} & \textbf{Tops} & \textbf{$\mathcal{A}_{E_I,E_{TEF}}$} & \textbf{$\mathcal{P}_{E_I,E_{TEF}}$} & \textbf{$\mathcal{S}_{E_I,E_{TEF}}$} \\ \Xhline{2\arrayrulewidth} 
minimalistic & c & 5 & 10.71 & 20.36 & 30.00 & 1 & 1 & 100.0 & 60.00 & 20.00 \\ \hline
minimalistic & cD & 35 & 10.53 & 55.26 & 100.0 & 0 & 3 & 47.06 & 63.53 & 80.00 \\ \hline
minimalistic & i & 11 & 19.35 & 39.68 & 60.00 & 1 & 1 & 100.0 & 75.00 & 50.00 \\ \hline
minimalistic$\triangle_{T}$ & iD & 15 & 13.68 & 46.84 & 80.00 & 1 & 2 & 100.0 & 82.50 & 65.00 \\ \Xhline{2\arrayrulewidth} 
sequentialCallRet & c & 2 & 10.34 & 26.60 & 42.86 & 1 & 1 & 100.0 & 57.14 & 14.29\% \\ \hline
sequentialCallRet & cD & 7 & 20.59 & 60.29 & 100.0 & 0 & 1 & 83.33 & 77.38 & 71.43\% \\ \hline
sequentialCallRet & i & 7 & 87.50 & 93.75 & 100.0 & 0 & 0 & 87.50 & 93.75 & 100.0 \\ \hline
sequentialCallRet & iD & 7 & 87.50 & 93.75 & 100.0 & 0 & 0 & 87.50 & 93.75 & 100.0 \\ \Xhline{2\arrayrulewidth}
\end{tabular}
}
\caption[Results of the synthetic binaries for the second version of the ACFR algorithm (Part 2).]{Results of the synthetic binaries for the second version of the ACFR algorithm which differed from the results obtained with the first version. Analyses which had to be interrupted as they did not finish within 2 hours are marked with $\triangle_{T}$.}
\label{tab:ACFR2SynDiff}
\end{table}
\\ \\
The results of the analysis of synthetic binaries using the second version of the ACFR algorithm can be observed in Table \ref{tab:ACFR2SynDiff}. This table only includes the two binaries which had a different precision when executed with the second version compared to the first version of the algorithm. The results of the second version of the algorithm is very similar to the first. In fact, the only time the analyses did not reconstruct the same CFA as the first version was for the  \it{sequentialCallRet} and \it{minimalistic}. As the former binary was the example of why the second algorithm was better than the first, illustrated in section \ref{sec:MotExamples}, this should not appear as a surprise. The second binary was a minimalistic c program compiled statically without stdlib. For this binary, the soundness of the CFA resulting from the \it{cD} mode increased from 60\% to 100\% for the CFA containing top edges.
\\ \\
...
\\ \\
As a final note, we invite the reader to notice that, for all binaries, the top edge free version of the CFA of the constant propagation analysis had a higher precision than the strided interval based analyses. The reason is that pure constant propagation results in very few edges which leads to having less false positives and thus to a very high accuracy. Hence, only looking at the precision metric to determine if a CFA is useful or not can be misleading. Rather, one needs to consider both the accuracy and the soundness to make this decision.
...
\Xhline{2\arrayrulewidth}
\textbf{Binary} & \textbf{Mode} & \textbf{Instructions} & \textbf{$\mathcal{A}_{E_I,E_G}$} & \textbf{$\mathcal{P}_{E_I,E_G}$} & \textbf{$\mathcal{S}_{E_I,E_G}$} & \textbf{uTops} & \textbf{Tops} & \textbf{$\mathcal{A}_{E_I,E_{TEF}}$} & \textbf{$\mathcal{P}_{E_I,E_{TEF}}$} & \textbf{$\mathcal{S}_{E_I,E_{TEF}}$} \\ \Xhline{2\arrayrulewidth} 
echo & c & 10 & 0.00211 & 0.00757 & 0.01302 & 1 & 1 & 100.0 & 50.00651 & 0.01302\% \\ \hline
echo $\triangle_{M}$ & cD & 59 & 0.00328 & 0.04216 & 0.08103 & 0 & 4 & 100.0 & 50.04052 & 0.08103\% \\ \hline
echo $\triangle_{T}$ & i & 1253 & 0.03355 & 0.94863 & 1.86372 & 9 & 9 & 91.47727 & 46.6705 & 1.86372\% \\ \hline
echo $\triangle_{T}$& iD & 1346 & 0.03607 & 1.02008 & 2.00408 & 9 & 9 & 92.02658 & 47.01533 & 2.00408\% \\ \Xhline{2\arrayrulewidth}
false & c & 10 & 0.00212 & 0.00763 & 0.01315 & 1 & 1 & 100.0 & 50.00657 & 0.01315\% \\ \hline
false $\triangle_{M}$& cD & 59 & 0.00329 & 0.04255 & 0.0818 & 0 & 4 & 100.0 & 50.0409 & 0.0818\% \\ \hline
false $\triangle_{T}$ & i & 1253 & 0.03365 & 0.95756 & 1.88147 & 9 & 9 & 91.47727 & 46.67937 & 1.88147\% \\ \hline
false $\triangle_{T}$& iD & 1346 & 0.03619 & 1.02968 & 2.02317 & 9 & 9 & 92.02658 & 47.02487 & 2.02317\% \\ \Xhline{2\arrayrulewidth}
...
%Main conclusions:
%Our alternating approach is not a good approach since the path extraction explodes in memory
...
\end{center}
Since this scales proportionally to $L_{lim}^2$, the number of paths in a CFA, where two loops are in serie, is quadratic in the maximum length of the paths $L_{lim}$. %In conclusion, for Figure \ref{fig:pathExpNested}.a, the number of possible paths polynomial in 
\begin{figure}[!t]
    \centering
\begin{tcolorbox}
\begin{minted}[xleftmargin=5pt,linenos,fontsize=\footnotesize]
SECTION .data
w1     db      'Too '
w2     db      'many '
w3     db      'paths', 0x0A
...
\Xhline{2\arrayrulewidth}
\textbf{Binary} & \textbf{Mode} & \textbf{Instructions} & \textbf{$T_{Jakstab}$} & \textbf{$T_{DFS}$} & \textbf{$T_{DSE}$} & \textbf{$T_{Other}$}\\ \Xhline{2\arrayrulewidth} 
badCall & c & 4 & 293 & 0 & 0 & 113\\ \hline
badCall & cD & 7 & 264 & 0 & 680 & 198\\ \hline
badCall & i & 7 & 256 & 0 & 0 & 145\\ \hline
badCall & iD & 7 & 256 & 0 & 0 & 216\\ \Xhline{2\arrayrulewidth} 
badIndMemJmp & c & 1 & 246 & 0 & 0 & 127\\ \hline
badIndMemJmp & cD & 1 & 190 & 0 & 620 & 201\\ \hline
badIndMemJmp & i & 1 & 103 & 0 & 0 & 147\\ \hline
badIndMemJmp & iD & 1 & 89 & 0 & 0 & 211\\ \Xhline{2\arrayrulewidth} 
branch & c & 17 & 323 & 0 & 0 & 123\\ \hline
branch & cD & 17 & 463 & 1 & 684 & 204\\ \hline
branch & i & 17 & 471 & 0 & 0 & 119\\ \hline
branch & iD & 17 & 474 & 0 & 0 & 210\\ \Xhline{2\arrayrulewidth} 
callRet & c & 2 & 266 & 0 & 0 & 136\\ \hline
callRet & cD & 6 & 267 & 3 & 657 & 208\\ \hline
callRet & i & 6 & 254 & 0 & 0 & 148\\ \hline
callRet & iD & 6 & 250 & 0 & 0 & 213\\ \Xhline{2\arrayrulewidth} 
cjmp & c & 11 & 291 & 0 & 0 & 127\\ \hline
cjmp & cD & 11 & 290 & 0 & 0 & 203\\ \hline
cjmp & i & 11 & 279 & 0 & 0 & 173\\ \hline
cjmp & iD & 11 & 269 & 0 & 0 & 252\\ \Xhline{2\arrayrulewidth} 
cjmpBitOp & c & 7 & 277 & 0 & 0 & 122\\ \hline
cjmpBitOp & cD & 7 & 278 & 0 & 0 & 194\\ \hline
cjmpBitOp & i & 8 & 267 & 0 & 0 & 142\\ \hline
cjmpBitOp & iD & 8 & 252 & 0 & 0 & 214\\ \Xhline{2\arrayrulewidth} 
conditionalTop & c & 11 & 303 & 0 & 0 & 129\\ \hline
...
\Xhline{2\arrayrulewidth}
\textbf{Binary} & \textbf{Mode} & \textbf{Instructions} & \textbf{$T_{Jakstab}$} & \textbf{$T_{DFS}$} & \textbf{$T_{DSE}$} & \textbf{$T_{Other}$}\\ \Xhline{2\arrayrulewidth} 
longRegisterEquals & c & 14 & 315 & 0 & 0 & 119\\ \hline
longRegisterEquals & cD & 14 & 302 & 0 & 702 & 189\\ \hline
longRegisterEquals & i & 14 & 319 & 0 & 0 & 142\\ \hline
longRegisterEquals & iD & 14 & 266 & 1 & 559 & 219\\ \Xhline{2\arrayrulewidth} 
memCallRet & c & 4 & 287 & 0 & 0 & 116\\ \hline
memCallRet & cD & 8 & 285 & 1 & 589 & 196\\ \hline
memCallRet & i & 8 & 261 & 0 & 0 & 141\\ \hline
memCallRet & iD & 8 & 255 & 0 & 0 & 224\\ \Xhline{2\arrayrulewidth} 
minimalistic & c & 5 & 276 & 0 & 0 & 132\\ \hline
minimalistic & cD & 11 & 280 & 0 & 632 & 215\\ \hline
minimalistic & i & 11 & 328 & 0 & 0 & 132\\ \hline
minimalistic $\triangle_{T}$ & iD & 15 & 7148928 & 9 & 626 & 291\\ \Xhline{2\arrayrulewidth} 
nestedCallRet & c & 3 & 272 & 0 & 0 & 122\\ \hline
nestedCallRet & cD & 8 & 270 & 1 & 1160 & 199\\ \hline
nestedCallRet & i & 8 & 260 & 0 & 0 & 154\\ \hline
nestedCallRet & iD & 8 & 238 & 0 & 0 & 231\\ \Xhline{2\arrayrulewidth} 
registerEquals & c & 8 & 301 & 0 & 0 & 127\\ \hline
registerEquals & cD & 8 & 285 & 1 & 605 & 214\\ \hline
registerEquals & i & 8 & 299 & 0 & 0 & 122\\ \hline
registerEquals & iD & 8 & 261 & 3 & 761 & 230\\ \Xhline{2\arrayrulewidth} 
sequentialCallRet & c & 2 & 276 & 0 & 0 & 133\\ \hline
sequentialCallRet & cD & 3 & 258 & 0 & 773 & 188\\ \hline
sequentialCallRet & i & 7 & 271 & 0 & 0 & 167\\ \hline
...
\Xhline{2\arrayrulewidth}
\textbf{Binary} & \textbf{Mode} & \textbf{Instructions} & \textbf{$T_{Jakstab}$} & \textbf{$T_{DFS}$} & \textbf{$T_{DSE}$} & \textbf{$T_{Other}$}\\ \Xhline{2\arrayrulewidth} 
badCall & c & 4 & 301 & 0 & 0 & 110\\ \hline
badCall & cD & 7 & 269 & 0 & 1202 & 203\\ \hline
badCall & i & 7 & 254 & 0 & 0 & 139\\ \hline
badCall & iD & 7 & 247 & 0 & 0 & 207\\ \Xhline{2\arrayrulewidth} 
badIndMemJmp & c & 1 & 240 & 0 & 0 & 123\\ \hline
badIndMemJmp & cD & 1 & 170 & 3 & 1684 & 220\\ \hline
badIndMemJmp & i & 1 & 95 & 0 & 0 & 159\\ \hline
badIndMemJmp & iD & 1 & 96 & 0 & 0 & 217\\ \Xhline{2\arrayrulewidth} 
branch & c & 17 & 320 & 0 & 0 & 123\\ \hline
branch & cD & 17 & 442 & 2 & 2019 & 177\\ \hline
branch & i & 17 & 477 & 0 & 0 & 121\\ \hline
branch & iD & 17 & 473 & 0 & 0 & 208\\ \Xhline{2\arrayrulewidth} 
callRet & c & 2 & 280 & 0 & 0 & 134\\ \hline
callRet & cD & 6 & 274 & 1 & 1152 & 183\\ \hline
callRet & i & 6 & 248 & 0 & 0 & 146\\ \hline
callRet & iD & 6 & 248 & 0 & 0 & 213\\ \Xhline{2\arrayrulewidth} 
cjmp & c & 11 & 290 & 0 & 0 & 122\\ \hline
cjmp & cD & 11 & 282 & 0 & 0 & 209\\ \hline
cjmp & i & 11 & 278 & 0 & 0 & 150\\ \hline
cjmp & iD & 11 & 270 & 0 & 0 & 226\\ \Xhline{2\arrayrulewidth} 
cjmpBitOp & c & 7 & 273 & 0 & 0 & 129\\ \hline
cjmpBitOp & cD & 7 & 291 & 0 & 0 & 183\\ \hline
cjmpBitOp & i & 8 & 260 & 0 & 0 & 146\\ \hline
cjmpBitOp & iD & 8 & 247 & 0 & 0 & 222\\ \Xhline{2\arrayrulewidth} 
...
\Xhline{2\arrayrulewidth}
\textbf{Binary} & \textbf{Mode} & \textbf{Instructions} & \textbf{$T_{Jakstab}$} & \textbf{$T_{DFS}$} & \textbf{$T_{DSE}$} & \textbf{$T_{Other}$}\\ \Xhline{2\arrayrulewidth} 
longRegisterEquals & c & 14 & 303 & 0 & 0 & 133\\ \hline
longRegisterEquals & cD & 14 & 301 & 1 & 949 & 193\\ \hline
longRegisterEquals & i & 14 & 308 & 0 & 0 & 126\\ \hline
longRegisterEquals & iD & 14 & 258 & 2 & 605 & 246\\ \Xhline{2\arrayrulewidth} 
memCallRet & c & 4 & 284 & 0 & 0 & 124\\ \hline
memCallRet & cD & 8 & 271 & 0 & 1092 & 182\\ \hline
memCallRet & i & 8 & 255 & 0 & 0 & 161\\ \hline
memCallRet & iD & 8 & 245 & 0 & 0 & 218\\ \Xhline{2\arrayrulewidth} 
minimalistic & c & 5 & 268 & 0 & 0 & 146\\ \hline
minimalistic & cD & 35 & 574 & 44 & 4615 & 725\\ \hline
minimalistic & i & 11 & 365 & 0 & 0 & 130\\ \hline
minimalistic$\triangle_{T}$ & iD & 15 & 7148204 & 7 & 686 & 293\\ \Xhline{2\arrayrulewidth} 
nestedCallRet & c & 3 & 271 & 0 & 0 & 133\\ \hline
nestedCallRet & cD & 8 & 279 & 1 & 1760 & 199\\ \hline
nestedCallRet & i & 8 & 253 & 0 & 0 & 154\\ \hline
nestedCallRet & iD & 8 & 278 & 0 & 0 & 211\\ \Xhline{2\arrayrulewidth} 
registerEquals & c & 8 & 291 & 0 & 0 & 133\\ \hline
registerEquals & cD & 8 & 268 & 1 & 624 & 206\\ \hline
registerEquals & i & 8 & 299 & 0 & 0 & 116\\ \hline
registerEquals & iD & 8 & 263 & 1 & 640 & 216\\ \Xhline{2\arrayrulewidth} 
sequentialCallRet & c & 2 & 269 & 0 & 0 & 121\\ \hline
sequentialCallRet & cD & 7 & 277 & 22 & 3644 & 655\\ \hline
sequentialCallRet & i & 7 & 271 & 0 & 0 & 150\\ \hline
...
\Xhline{2\arrayrulewidth}
\textbf{Binary} & \textbf{Mode} & \textbf{Instructions} & \textbf{$T_{Jakstab}$} & \textbf{$T_{DFS}$} & \textbf{$T_{DSE}$} & \textbf{$T_{Other}$}\\ \Xhline{2\arrayrulewidth} 
echo & c & 10 & 293 & 0 & 0 & 302\\ \hline
echo $\triangle_{M}$ & cD & 59 & 1315 & 32 & 4064 & 957\\ \hline
echo $\triangle_{T}$ & i & 1253 & 7157728 & 0 & 0 & 241\\ \hline
echo $\triangle_{T}$& iD & 1346 & 7157956 & 0 & 0 & 570\\ \Xhline{2\arrayrulewidth}
false & c & 10 & 293 & 0 & 0 & 322\\ \hline
false $\triangle_{M}$& cD & 59 & 1396 & 56 & 4302 & 968\\ \hline
false $\triangle_{T}$ & i & 1253 & 7153636 & 0 & 0 & 206\\ \hline
false $\triangle_{T}$& iD & 1346 & 7156047 & 0 & 0 & 280\\ \Xhline{2\arrayrulewidth}
make-prime-list & c & 10 & 297 & 0 & 0 & 303\\ \hline
make-prime-list $\triangle_{M}$ & cD & 59 & 1142 & 35 & 3633 & 644\\ \hline
make-prime-list $\triangle_{T}$& i & 1346 & 7153572 & 0 & 0 & 207\\ \hline
make-prime-list $\triangle_{T}$& iD & 1346 & 7156736 & 0 & 0 & 294\\ \Xhline{2\arrayrulewidth}
printenv & c & 10 & 283 & 0 & 0 & 328\\ \hline
printenv $\triangle_{M}$ & cD & 59 & 1164 & 32 & 3582 & 639\\ \hline
printenv $\triangle_{T}$& i & 1253 & 7153785 & 0 & 0 & 216\\ \hline
printenv $\triangle_{T}$& iD & 1346 & 7156810 & 0 & 0 & 296\\ \Xhline{2\arrayrulewidth}
true & c & 10 & 300 & 0 & 0 & 302\\ \hline
true $\triangle_{M}$& cD & 59 & 1192 & 36 & 3459 & 755\\ \hline
true $\triangle_{T}$& i & 1253 & 7158645 & 0 & 0 & 221\\ \hline
true $\triangle_{T}$& iD & 1346 & 7157823 & 0 & 0 & 290\\ \Xhline{2\arrayrulewidth}
\end{tabular}
}
\caption[Execution times for the evaluation of the 5 smallest GNU coreutils binaries using the first version of the ACFR algorithm.]{Execution times for the evaluation of the 5 smallest GNU coreutils binaries using the first version of the ACFR algorithm.}
\label{tab:ACFR1GNUCoreutilsExe}
\end{table}
...
\Xhline{2\arrayrulewidth}
\textbf{Binary} & \textbf{Mode} & \textbf{Instructions} & \textbf{$T_{Jakstab}$} & \textbf{$T_{DFS}$} & \textbf{$T_{DSE}$} & \textbf{$T_{Other}$}\\ \Xhline{2\arrayrulewidth} 
echo & c & 10 & 288 & 0 & 0 & 310\\ \hline
echo $\triangle_{M}$ & cD & 59 & 1147 & 47 & 3983 & 687\\ \hline
echo $\triangle_{T}$ & i & 1253 & 7155590 & 0 & 0 & 218\\ \hline
echo $\triangle_{T}$ & iD & 1346 & 7154816 & 0 & 0 & 308\\ \Xhline{2\arrayrulewidth}
false & c & 10 & 324 & 0 & 0 & 304\\ \hline
false $\triangle_{M}$ & cD & 59 & 1531 & 39 & 4840 & 975\\ \hline
false $\triangle_{T}$ & i & 1253 & 7154597 & 0 & 0 & 221\\ \hline
false $\triangle_{T}$ & iD & 1346 & 7153839 & 0 & 0 & 285\\ \Xhline{2\arrayrulewidth}
make-prime-list & c & 10 & 291 & 0 & 0 & 277\\ \hline
make-prime-list $\triangle_{M}$ & cD & 59 & 1111 & 34 & 3503 & 666\\ \hline
make-prime-list $\triangle_{T}$ & i & 1346 & 7154939 & 0 & 0 & 210\\ \hline
make-prime-list $\triangle_{T}$ & iD & 1346 & 7153194 & 0 & 0 & 270\\ \Xhline{2\arrayrulewidth}
printenv & c & 10 & 287 & 0 & 0 & 312\\ \hline
printenv $\triangle_{M}$ & cD & 59 & 1196 & 34 & 4041 & 755\\ \hline
printenv $\triangle_{T}$ & i & 1253 & 7153311 & 0 & 0 & 211\\ \hline
printenv $\triangle_{T}$ & iD & 1346 & 7154729 & 0 & 0 & 354\\ \Xhline{2\arrayrulewidth}
true & c & 10 & 303 & 0 & 0 & 305\\ \hline
true $\triangle_{M}$ & cD & 59 & 1185 & 29 & 3795 & 715\\ \hline
true $\triangle_{T}$ & i & 1253 & 7153809 & 0 & 0 & 219\\ \hline
true $\triangle_{T}$ & iD & 1346 & 7156424 & 0 & 0 & 289\\ \Xhline{2\arrayrulewidth}
\end{tabular}
}
\caption[Execution times for the evaluation of the 5 smallest GNU coreutils binaries using the second version of the ACFR algorithm.]{Execution times for the evaluation of the 5 smallest GNU coreutils binaries using the second version of the ACFR algorithm.}
\label{tab:ACFR2GNUCoreutilsExe}
\end{table}
...
% \end{tabular}
% }
% \caption[Results of the synthetic binaries for the second version of the ACFR algorithm (Part 1).]{Results of the synthetic binaries for the second version of the ACFR algorithm (Part 1). Analyses which had to be interrupted as they did not finish within 2 hours are marked with $\triangle_{T}$.}
% \label{tab:ACFR2Syn1}
% \end{table}
...
% \end{tabular}
% }
% \caption[Results of the synthetic binaries for the second version of the ACFR algorithm (Part 2).]{Results of the synthetic binaries for the second version of the ACFR algorithm (Part 2). Analyses which had to be interrupted as they did not finish within 2 hours are marked with $\triangle_{T}$.}
% \label{tab:ACFR2Syn2}
% \end{table}
...
% \Xhline{2\arrayrulewidth}
% \textbf{Binary} & \textbf{Mode} & \textbf{Instructions} & \textbf{States} & \textbf{DSE Requests} & \textbf{DSE Edges} & \textbf{$T_{Jakstab}$} & \textbf{$T_{DFS}$} & \textbf{$T_{DSE}$} & \textbf{$T_{Other}$}\\ \Xhline{2\arrayrulewidth} 
